    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    // Permitir acceso a endpoints de métricas y health check
                    auth.requestMatchers("/health", "/actuator/health", "/actuator/info", "/actuator/prometheus", "/actuator/metrics/**").permitAll();
